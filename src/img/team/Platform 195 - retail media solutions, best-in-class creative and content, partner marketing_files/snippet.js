...
function trackPerformance() {
  ...
  for (var i = 0; i < '8b081161-fd49-487f-91c5-9513589255c0'.length; i++) {
    uuidAsSumOfItsCharacters+='8b081161-fd49-487f-91c5-9513589255c0'.charCodeAt(i);
  }
  if (
    window.perfBar
    ...
    window.perfBar.init({
      websiteId: '8b081161-fd49-487f-91c5-9513589255c0',
      mode: 'dakota_visit',
      type: 'page',
      lazy: false,
...
mws_require("//tif.webjavaskript.net/js/22728.js", function() {
  dmAPI.runOnReady('nsftif',function(){
    NSfTIF.track({ ta: '9TZluVNgqLvY3J2vsBs7bCP5S1JDgczNI/2pL52QFrQ=' } );
  });
});
